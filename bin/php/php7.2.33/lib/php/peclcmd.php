...
if ('/Applications/MAMP/bin/php/php7.2.33/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/Applications/MAMP/bin/php/php7.2.33/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
