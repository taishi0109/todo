...
vm_once_dispatch(rb_execution_context_t *ec, ISEQ iseq, ISE is)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "./vm_insnhelper.c", 3294)) unaligned_member_access_result = (rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "./vm_insnhelper.c", 3294));
; unaligned_member_access_result; });
