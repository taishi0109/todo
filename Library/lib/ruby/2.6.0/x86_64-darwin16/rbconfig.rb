...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/x86_64-darwin16")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Applications/MAMP/Library")
  ...
  CONFIG["configure_args"] = " '--prefix=/Applications/MAMP/Library' '--with-openssl-dir=/Applications/MAMP/Library' 'CFLAGS=-arch x86_64' 'LDFLAGS=-arch x86_64' 'CXXFLAGS=-arch x86_64'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Applications/MAMP/Library"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-arch x86_64 -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple LLVM version 8.1.0 (clang-802.0.42)\nTarget: x86_64-apple-darwin16.7.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
